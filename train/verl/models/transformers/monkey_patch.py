...
def apply_monkey_patch(model: PreTrainedModel, ulysses_sp_size: int):
    ...
    if model.config.model_type in ("qwen2_vl", "qwen2_5_vl"):  # patch remove padding for qwen2vl mrope
        # transformers.models.qwen2_5_vl.modeling_qwen2_5_vl这个库不存在
        try:
            from transformers.models.qwen2_5_vl.modeling_qwen2_5_vl import Qwen2_5_VLFlashAttention2
            from transformers.models.qwen2_vl.modeling_qwen2_vl import Qwen2VLFlashAttention2
        except:
            from transformers.models.qwen2_5_vl.modeling_qwen2_5_vl import Qwen2_5_VLModel as Qwen2_5_VLFlashAttention2
            from transformers.models.qwen2_5_vl.modeling_qwen2_vl import Qwen2_VLModel as Qwen2VLFlashAttention2
